...
insert into Empleado (Nombre,Email,Dni,Rol,Estado) values ('Gerente','gerente@bulldog.com',40391972,1,1)
...
insert into Habitacion(Numero,Piso,Estado,Tipo) values (5,1,1,1)
insert into Habitacion(Numero,Piso,Estado,Tipo) values (6,2,1,2)
insert into Habitacion(Numero,Piso,Estado,Tipo) values (7,3,1,3)
insert into Habitacion(Numero,Piso,Estado,Tipo) values (8,2,1,4)
insert into Cliente (Nombre,Email,Dni,Estado) values ('Juan Tonello','juan@gmail.com',40391962,1)
insert into Cliente (Nombre,Email,Dni,Estado) values ('Jorge Gomez','jorge@gmail.com',40391932,1)
insert into Cliente (Nombre,Email,Dni,Estado) values ('Mariano Gonzalez','mariano@gmail.com',40391922,1)
insert into Cliente (Nombre,Email,Dni,Estado) values ('Candela Galeano','cande@gmail.com',40391122,1)
