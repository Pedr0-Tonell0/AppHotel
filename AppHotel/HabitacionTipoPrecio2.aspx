...
<div class="description">
      ...
      <center> 
          <asp:Chart runat="server" ID="Graficos" BackColor="WindowFrame" BorderlineColor="DarkGray" DataSourceID="SqlDataSource1" Palette="SemiTransparent">
        <Series>
            <asp:Series Name="Series" XValueMember="Nombre" YValueMembers="Precio"></asp:Series>
        </Series>
        <ChartAreas>
            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
        </ChartAreas>
              <Titles>
                  <asp:Title Font="Microsoft Sans Serif, 8.25pt, style=Bold" ForeColor="White" Name="Title1" Text="Precio de los tipos de habitaciones">
                  </asp:Title>
              </Titles>
    </asp:Chart>
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AppHotelConnectionString %>" SelectCommand="SELECT [Nombre], [Precio] FROM [TipoHabitacion]"></asp:SqlDataSource>
             </center>  
            ...
            <div class="fresh-table full-color-red" style="width: 100%;">
                ...
                <table id="fresh-table" class="table">
                    <thead>
                        ...
                        <th data-field="Apellido" data-sortable="true">Precio</th>
                                                <th data-field="Cuatrimestre" data-sortable="true">Disponibles</th>
                        <th data-field="Precio" data-sortable="true">Alquiladas</th>
            ...
            { %>
                        ...
                        <th><% = item.Tipo.Disponibles%></th>
                        <th><% = item.Tipo.Alquiladas%></th>
                        </tr>
                                <% } %>
                    </tbody>
                </table>
