<%@ Page Title="Eliminar" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ClienteEliminar.aspx.cs" Inherits="AppHotel.ClienteEliminar" %>
...
<asp:Content ID="home" ContentPlaceHolderID="cuerpo" runat="server">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <center> <p>Usted esta seguro de eliminar a  <%=Cliente.Nombre%>?</p></center>  
        <div class="row">
            <div class="col-12-xs text-center">
                <asp:Button ID="Si" runat="server" Text="Si" class="btn btn-success btn-md" OnClick="Si_Click"/>
                <a href="ClienteABML.aspx" class="btn btn-danger btn-md">Volver</a>
